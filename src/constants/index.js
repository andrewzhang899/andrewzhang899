...
const testimonials = [
  {
    testimonial:
      "Andrew is an exceptional full stack developer with expertise in both front-end and back-end tasks. Highly recommended for professionalism and high-quality results.",
    name: "Chris S.",
    designation: "CTO",
    company: "AutoNinjas",
  ...
  {
    testimonial:
      "Andrew is a web3 full stack developer with exceptional skills in both front-end and back-end development. His expertise and collaborative approach make them a valuable asset for any web3 project.",
    name: "Vanessa L.",
    designation: "Management Consulting",
    company: "Myria",
    image:
      "https://media.licdn.com/dms/image/C5603AQEh_alBX4RWmw/profile-displayphoto-shrink_200_200/0/1643176550140?e=1691020800&v=beta&t=_O3tbiN0FNAGtehsgPoaUg7e4Ecvn8ppysRAQdr9GeA",
  },
  // {
  //   testimonial:
